  ...
  return (
    <section className="my-5">
      <div className="container d-flex flex-column text-center">
        ...
        <div className="p-2">
          <p className="aboutMe">
            HR Manager with a penchant for learning, I decided to try web development. I had never tried my hand at something as logical as web development, but here I am, unscathed from an intense six-month bootcamp. 
